        ...
        <div class="col-lg-10">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    <a href="<?= url('cliente/perfil/editar') ?>" class="btn btn-success">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= url('cliente/perfil/editar') ?>" class="btn btn-sm btn-outline-success">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-3 text-center">
                                    <?php if ($fotoExiste): ?>
                                        <img src="<?= url('uploads/perfil/' . htmlspecialchars($fotoNome)) ?>"
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= url('cliente/solicitacoes') ?>" class="btn btn-sm btn-outline-primary">
                                Ver Todas
                            </a>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <a href="<?= url('cliente/propostas/recebidas') ?>" class="btn btn-outline-success">
                                    <i class="bi bi-envelope me-2"></i>Ver Propostas
                                </a>
                                <a href="<?= url('cliente/solicitacoes') ?>" class="btn btn-outline-info">
                                    <i class="bi bi-list-task me-2"></i>Minhas Solicitações
                                </a>
                                <a href="<?= url('cliente/perfil/enderecos') ?>" class="btn btn-outline-secondary">
