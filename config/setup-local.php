...
try {
    ...
    if (file_exists($sqlFile)) {
        ...
        echo "</ul>";
        echo "<p><a href='/chamaservico/' style='background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>🏠 Acessar Sistema</a></p>";
        echo "<p><a href='/chamaservico/config/test-connection.php' style='background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-left: 10px;'>🔍 Testar Conexão</a></p>";
        echo "</div>";
